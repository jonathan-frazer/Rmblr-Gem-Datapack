...
#Effects
execute at @s run function mob_gem:mob_gem/rabbit/leap/2_fx

#Reset
execute if score @s mbGemLeap matches 15.. at @s unless block ~ ~-0.1 ~ #mob_gem:passable run function mob_gem:mob_gem/rabbit/leap/end
execute if score @s mbGemLeap matches 15.. at @s if block ~ ~ ~ water run function mob_gem:mob_gem/rabbit/leap/end
