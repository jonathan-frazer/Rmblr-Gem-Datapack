...
$execute if score mbGemStealOffset mbGem_fakePlayer matches ..$(Slot) run function mob_gem:mob_gem/allay/steal_item/player/2i with storage mob_gem:auxillary Allay.StolenItems