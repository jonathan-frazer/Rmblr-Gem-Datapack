...
#Receive Gem
execute unless data storage mob_gem:gem_acquire GemsCurrentlySpawned.mbGem_piglin run summon item ~ ~1 ~ {Item:{components:{"custom_model_data":523190,"custom_data":{mbGem:1b},"lore":['{"color":"green","italic":false,"text":"Ability: Consume Gold for a Piglin-Trade"}','{"color":"aqua","italic":false,"text":"Perk: Significantly Boosts Gold Armor"}'],"custom_name":'{"color":"#c78064","italic":false,"text":"Piglin Gem"}'},count:1,id:"warped_fungus_on_a_stick"},Motion:[0.0,0.0,0.0],PickupDelay:0s}
